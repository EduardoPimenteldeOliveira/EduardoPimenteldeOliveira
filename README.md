...
Estudante de Engenharia da Computação na FACAMP com experiência prática em automação de processos industriais, análise de dados e redes neurais. Já entreguei projetos reais reduzindo tempo de operação em mais de 90% em parceria com empresas como **BOSCH** e **SIG GROUP**.

Busco estágio na área de **Dados, IA ou Desenvolvimento** para aplicar e expandir esses conhecimentos em desafios reais.
...
| Empresa | Período | Resultado |
|---|---|---|
| 🔧 **BOSCH** — CITEC/FACAMP | 02/25 – 12/25 | +20 calculadoras automatizadas · redução de 90% no tempo de cálculo (30min → 2min) |
| ⚙️ **SIG GROUP** — CEAF/FACAMP | 02/26 – 12/26 | Monitoramento de 7 máquinas e 180+ peças · redução de 17% no tempo de setup |
...
<div align="center">
  <img src="https://komarev.com/ghpvc/?username=EduardoPimenteldeOliveira&color=6e40c9&style=flat-square&label=Visitas+ao+perfil" alt="profile views"/>
</div>
